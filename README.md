...
#### red/black tree
#### splay tree (recommend)
#### AVL tree
### Understand tree traversal algorithms: 
#### BFS 
#### DFS 
###### differences between inorder, postorder and preorder. 
## Graphs: Graphs are really important at Google.  There are 
### Ways to represent a graph w/ pros & cons.  
#### Edge List
#### Adjacency Matrix
#### Adjacency List
### Graph traversal algorithms: Know their computational complexity, their tradeoffs, and how to implement them in real code. 
#### breadth-first search 
#### depth-first search.  
### If you get a chance, try to study up on fancier algorithms such as 
#### Dijkstra 
#### A* search
#### (suggested) Kruskals Algorithm
